# Node.js Server Boilerplate (ESM)

## Overview

A robust boilerplate for building scalable, production-ready REST APIs with Node.js, Express, MongoDB (Mongoose), and ECMAScript Modules (ESM).
...
This project is licensed under the MIT License. See [LICENSE](file:///Users/donymvarkey/Projects/create-mexn-app-templates/esm-js/LICENSE) for details.
